        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InternationalName = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Opis", "Amoxicillin clavulanate", "Kwas klawulanowy" });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Name" },
                values: new object[] { 1, "Ból" });

            migrationBuilder.InsertData(
                table: "Drugs",
                columns: new[] { "DrugId", "ActiveSubstanceId", "CategoryId", "Dosage", "ImageURL", "PackSize", "Price", "Quantity", "TradeName" },
                values: new object[] { 1, 1, 1, "1 tabletka", "https://www.sennik.biz//o/l/z/w336/lzndk3ruq8xh.jpg", "50 tabletek", 31.99m, 59, "Nazwa leku" });
        }
